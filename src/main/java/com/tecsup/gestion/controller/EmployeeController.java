...
public class EmployeeController {
	...
	@GetMapping("/admin/emp/list2")
	public String list2(@ModelAttribute("employee") Employee employee, ModelMap model) {
	...
	public ModelAndView create(@ModelAttribute("employee") @Valid Employee emp, BindingResult result, ModelMap model) {
		...
		////////////////////////////////////////////////////////////////////////////////////
		@GetMapping("/admin/emp/createformWithRole")
		public ModelAndView getWithRole() {
		
		Employee emp = new Employee();
		
		ModelAndView modelAndView = new ModelAndView("admin/emp/list2", "employee", emp);
